            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 flex flex-col overflow-auto p-8">
                    <div className="bg-gradient-to-r from-gray-700 to-gray-800 text-center p-4 rounded-md shadow-lg">
                        <h1 className="text-3xl text-white font-bold">Update Customer Details</h1>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                {['FirstName', 'LastName', 'NIC', 'MobileNumber', 'Email', 'Address'].map((field) => (
                                    <div key={field}>
                                        ...
                                        <input
                                            ...
                                            className={`w-full border border-gray-300 p-3 mt-1 rounded-lg focus:ring-2 focus:ring-blue-500 transition duration-200 ${field === 'Email' ? 'bg-gray-200 outline-none' : ''}`}
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full border border-gray-300 p-3 mt-1 rounded-lg bg-gray-200 outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
